...
function AddShows() {
  ...
  const handleSubmit = async () => {
    try {
        ...
        if(data.success){
         ...
         toast.error("error occured please try agaim")
    }
    setAddingShow(false);
  }
  ...
  const handleDateTimeAdd = ()=>{
    ...
    const handleRemoveTime = (date,time)=>{
        setDateTimeSelection((prev) => {
             const filteredTime = prev[date].filter(t => time !== t)
    ...
    <div>
        ...
        <div className='overflow-x-auto no-scrollbar pb-4'>
            ...
            <div className='mt-8'>
                ...
                <div className='inline-flex items-centergap-2 border border-gray-600 px-3 py-2 rounded-md'>

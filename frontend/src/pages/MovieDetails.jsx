                  ...
                  <p className='text-grey-400 mt-2 text-sm leading-tight max-w-xl '>{show.movie.overview}</p>
                    ...
                    <p>
                      ...
                      <div className='flex items-center gap-4 flex-wrap mt-4'>
                        <button className='flex items-center gap-2 bg-gray-800 px-7 py-3 text-sm hover:bg-gray-900 transition rounded-md font-medium cursor-pointer active:scale-95'>
                          <PlayCircleIcon className='w-5 h-5'/>
                          Watch Trailer
                          </button>
                        <a href="#DateSelect" className='px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition  rounded-md font-medium cursor-pointer active:scale-95 '>Buy Tickets</a>
                        <button onClick={handleFavorite} className='bg-gray-700 p-2.5 rounded-full transition  font-medium cursor-pointer active:scale-95 '>
            ...
            <div className='flex items-center gap-4 w-max px-4'>
                {show.movie.casts.slice(0,12).map((cast,index)=>{
                  return <div key={index} className='flex flex-col items-center text-center'>
                      <img src={image_base_url +  cast.profile_path } alt="" className='rounded-full h-20 aspect-square object-cover' />

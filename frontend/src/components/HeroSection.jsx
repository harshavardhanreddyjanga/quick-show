  ...
  return (
    <div  style={{ backgroundImage: `url(${assets.backgroundImage})` }}className = {` flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-cover bg-center h-screen `}>
         ...
         <p className='max-w-md text-gray-300'>
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sed aut expedita nihil pariatur labore, vitae quae necessitatibus 
         </p>
         <button onClick={()=>navigate('/movies')} className='flex items-center gap-1 px-3 py-3 bg-primary hover:bg-primary-dull transition rounded-full font-medium cursor-pointer'>
            Explore Movies
